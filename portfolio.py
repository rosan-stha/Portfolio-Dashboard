...
# ══════════════════════════════════════════════════════════════════════════════
# TAB 3 — ACTIVITY (from uploaded history CSV or static)
# ══════════════════════════════════════════════════════════════════════════════
with tab3:
    ...
    if hist_file:
        ...
        # Monthly volume chart if date+amount columns exist
        if len(cols) >= 4:
            st.dataframe(hist_df.head(50), use_container_width=True, height=400)
    else:
        # Demo activity from PayPay HTML data
...
with tab4:
    ...
    # Sample dividend data (replace with real when CSV has dividend column)
